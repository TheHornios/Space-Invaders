...
public class Parapeto extends ObjetosJuego{
	private int vidas;
	private EstadoJuego_Dificil estadoJuego;
	 ...
	 */
	public Parapeto(Vector2D a, BufferedImage b,EstadoJuego_Dificil d,BufferedImage z,BufferedImage w,BufferedImage y) {
		super(a, b);
		vidas =4;
		estadoJuego = d;
		textura1 = z;
	 ...
	 *  @see objetosJuego_Dificil.DisparoNave
	 *  @see objetosJuego_Dificil.DisparosMarcianos
